...
| 场景 | 单价 |
|------|------|
| 有视频输入的有声视频 | 0.0294 元 / K tokens |
| 有视频输入的无声视频 | 0.0294 元 / K tokens |
| 没有视频输入的有声视频 | 0.0483 元 / K tokens |
| 没有视频输入的无声视频 | 0.0483 元 / K tokens |
...
| 参数 | 类型 | 必填 | 默认值 | 说明 |
|------|------|------|--------|------|
| resolution | string | - | 720p | 分辨率：480p、720p 或 1080p（**WAN 2.0 Fast 文生视频不支持 1080p**，仅 480p/720p） |
...
| 分辨率选项 | 480p, 720p, 1080p（WAN 2.0 Fast 文生视频仅 480p/720p） |
| 参考图片数量上限 | 9 张 |
