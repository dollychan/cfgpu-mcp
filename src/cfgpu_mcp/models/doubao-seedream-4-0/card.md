...
|------|-----|
| 任务类型 | image |
| CFGPU 模型 ID | `Doubao-Seedream-4.0` |
...
| model | string | ✓ | - | 模型 ID：`Doubao-Seedream-4.0` |
...
| 档位 | 说明 |
|------|------|
| 1K | 总像素约 92万-105万。**4.0 独有**——5.0 lite / 4.5 的像素下限是 368 万，1K 落不进去 |
| 2K | 总像素约 368万-400万 |
| 3K | 总像素约 900万-940万 |
| 4K | 总像素约 1600万-1670万 |
...
| resolution | size | 1K/2K/3K/4K 档位映射成精确像素（1K 仅 4.0 支持） |
