...
│   │   └── card.md
│   ├── cfgpu-minimax-h3/
│   │   ├── adapter.yaml        MiniMax-H3（provider: cfgpu，内建；逐请求令牌对它生效），resolutions: [480p, 768p, 2k] + default_resolution: 768p，4–15s
│   │   └── card.md
