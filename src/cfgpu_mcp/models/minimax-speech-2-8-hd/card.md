...
`voice` 参数（映射到 `input.voice_setting.voice_id`）的可选系统音色如下。默认 `male-qn-qingse`。
来源：MiniMax 开放平台文档（<https://platform.minimaxi.com/docs/llms.txt>）。

| 序号 | 语言 | 音色 ID (Voice ID) | 音色名称 |
| :-- | :-- | :-- | :-- |
